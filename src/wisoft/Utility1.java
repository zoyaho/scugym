...
public class Utility1 extends QueryDB1 {
  ...
  public String addYear(int n, String start_date) throws IOException, SQLException {
    Calendar rightNow = Calendar.getInstance();
    String[] rs_splis = start_date.split("-");
    rightNow.set(1, Integer.parseInt(rs_splis[0]));
    rightNow.set(2, Integer.parseInt(rs_splis[1]) - 1);
    ...
    switch (status) {
      ...
      case 201:
        ...
        while ((line = br.readLine()) != null) {
          ...
          cst.SaveReader("0", readerstatus, msg, UID, NAME, TYPE, DEAPRT_1, DEAPRT_2, YEAR, CARDID, "", "", "", "", hexCARDID);
          cst.closeall();
        } 
        br.close();
        break;
  ...
  static NodeFilter lnkFilter = new NodeFilter() {
      public boolean accept(Node node) {
        if (node instanceof Utility1.z303GoTag)
          return true; 
        return false;
      }
    };
