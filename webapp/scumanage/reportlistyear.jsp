...
String exportToExcel = request.getParameter("exportToExcel");
	...
	%>
	<a href="reportlistyear1.jsp?<%=url%>&exportToExcel=YES&type1=excel">匯出Excel</a>
	<a href="reportlistyear1.jsp?<%=url%>&exportToExcel=YES&type1=txt">匯出doc</a>
	<!-- 
	<a href="reportlistyear2.jsp?<%=url%>&exportToExcel=YES&type1=excel" target="_blank">郵寄excel</a>
	<a href="reportlistyear2.jsp?<%=url%>&exportToExcel=YES&type1=txt" target="_blank">郵寄doc</a>
	 -->
	<%
	    }
  ...
  <div class="table">
     ...
     <%
     	while(i < monthofyear)
     	{
            ...
            %></div>
            <div class="column"><%
            		zone11 = rst.countloginYear(Integer.parseInt(param), Integer.toString(i+1), "11:00-12:00",location);
            	out.print(zone11);
            	zone11_total += zone11;
            %></div>
            <div class="column"><%
            		zone12 = rst.countloginYear(Integer.parseInt(param), Integer.toString(i+1), "12:00-13:00",location);
            	out.print(zone12);
            	zone12_total += zone12;
            %></div>
            <div class="column"><%
