...
String exportToExcel = request.getParameter("exportToExcel");
	...
	%>
	<a href="reportarealist1.jsp?<%=url%>&exportToExcel=YES&type1=excel">匯出Excel</a>
	<a href="reportarealist1.jsp?<%=url%>&exportToExcel=YES&type1=txt">匯出doc</a>
...
<h3><%=param %>年<%=param1 %>月 <%=locname %>座位區域人次統計表</h3>
  <div class="table">
     ...
     <%
     	while(i < dayofmonth)
     	{
     		...
     		%>
     			<div class="column">
           		<%
            		zone1 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"3","20");//A區
            		out.print(zone1);
            		zone1_total += zone1;
            	%>
            	</div>
            	<div class="column"><%
            		zone2 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"4","20");//B區
            		out.print(zone2);
            		zone2_total += zone2;
            	%>
            	</div>
           	 	<div class="column"><%
            		zone3 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"2","20");//C區
            		out.print(zone3);
            		zone3_total += zone3;
            	%>
            	</div>
     		 ...
     		 { 
           	 	%>
           	 	<div class="column"><%
            		zone4 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"3","52");//A
            		out.print(zone4);
            		zone4_total += zone4;
            	%>
            	</div>
            	<div class="column"><%
            		zone5 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"61","52");//B1
            		out.print(zone5);
            		zone5_total += zone5;
            	%>
            	</div>
            	<div class="column"><%
            		zone6 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"62","52");//B2
            		out.print(zone6);
            		zone6_total += zone6;
            	%>
            	</div>
            	<div class="column"><%
            		zone7 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"63","52");//B3
            		out.print(zone7);
            		zone7_total += zone7;
            	%>
            	</div>
            	<div class="column"><%
            		zone8 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"70","52");//B4
            		out.print(zone8);
            		zone8_total += zone8;
            	%>
            	</div>
            	<div class="column"><%
            		zone9 = rst.countarealogin(Integer.parseInt(param), param1,(i+1),"71","52");//C
            		out.print(zone9);
            		zone9_total += zone9;
            	%>
            	</div>
     ...
     %>
      ...
      <div class="column">總計 </div>
       ...
       if(location.equals("20"))
       {
    	   %>
    	      ...
    	      <div class="column"><% total1 = zone1_total+zone2_total+zone3_total; out.print(total1); %></div>
    	     <%
       } 
       else if(location.equals("52")){
    	   %>
         ...
         <div class="column"><% total1 = zone4_total+zone5_total+zone6_total+zone7_total+zone8_total+zone9_total;
         out.print(total1);
         	%></div>
      ...
      <div class="column"><%=zone2_total %></div>
      <div class="column"><%=zone3_total %></div>
      <div class="column">小計 : <% total1 = zone1_total+zone2_total+zone3_total; out.print(total1); %></div>
       <div class="column"><%=zone4_total %></div>
        <div class="column"><%=zone5_total %></div>
          <div class="column"><%=zone6_total %></div>
           <div class="column"><%=zone7_total %></div>
      ...
      <div class="column"> 小計 :<% total2 = zone4_total+zone5_total+zone6_total+zone7_total+zone8_total+zone9_total;
      out.print(total2);
      	%></div>
