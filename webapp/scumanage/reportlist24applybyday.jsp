...
<div id="srt">
	...
	<a href="reportlist24applybyday1.jsp?<%=url%>&exportToExcel=YES&type=excel">匯出Excel</a>
	<a href="reportlist24applybyday1.jsp?<%=url%>&exportToExcel=YES&type=txt">匯出doc</a>
	 <!-- 
...
<div>總查詢筆數 : <%=up %>筆</div>
    <div class="table">
        <div class="table-head">
            ...
            <div class="column" data-label="單位">單位</div>
            <div class="column" data-label="姓名">姓名</div>
            <div class="column" data-label="申請日期時間">申請日期時間</div>
        ...
        while(rs.next())
        {
        	...
        	rst1.getReaderByHex(cardid);
          %>
       	<div class="row">
        	<div class="column" data-label="序號"><%=i+1 %></div>
            <div class="column" data-label="讀者證"><%=rst1.showData("uid", 0) %></div>
            <div class="column" data-label="單位"><% 
            ...
            %></div>
            <div class="column" data-label="姓名"><%= rst1.showData("name", 0) %></div>
            <div class="column" data-label="申請日期時間"><%=applydate %></div>
