...
<!--
  ...
  <aside id="aside"> until a full-grown man </aside>
    ...
    <article class="login-wrap">
      <form class="login mc-active" action="login_ok.jsp" class="mc-active" method="post" id="mc-form">
 ...
 <script type="text/javascript" src="js/main.js"></script>
		...
		function reload(){
			...
			var a = $("#account").val();
			var b = $("#password").val();
			$( "#login" ).load( "login1.jsp", { account:a.trim(), password:b.trim(),v:new Date().getTime()} );
